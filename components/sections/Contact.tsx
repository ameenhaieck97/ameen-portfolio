  ...
  return (
    <section id="contact" className="relative py-32 sm:py-48">
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-10">
          ...
          <RevealItem>
            <Magnetic strength={0.25} className="inline-flex">
              <a
                ...
                className="glass group flex items-center gap-4 rounded-full px-7 py-4 transition-all duration-300 hover:border-gold/30"
              >
        ...
        <Reveal variant="fadeUp" delay={0.32} className="mt-10">
          <p className="text-sm text-ivory/45">{t("formNote")}</p>
        </Reveal>
          ...
          {contact.social.map(({ key, href }) => {
            ...
            return (
              <a
                ...
                rel="noreferrer noopener"
                aria-label={key}
                className="glass flex h-12 w-12 items-center justify-center rounded-full text-ivory/70 transition-colors hover:text-gold"
              >
